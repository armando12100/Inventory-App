      ...
      <div className='relative'>
        ...
        <div className='absolute top-1/3 pl-14'>
          ...
          <div className='pt-12 lg:text-2xl sm:text-lg'>Armando Sanchez 
            <span className='pl-6 lg:text-2xl sm:text-lg'>March 26, 2024</span>
            <p className='font-bold sm:text-2xl pt-10 lg:pt-16 lg:text-3xl'>The Best Meta Decks for Into the Inklands!</p>
          </div>
        </div>
      </div>
      <div className='mt-10 w-1/2 bg-blue-950 flex flex-col text-white justify-center items-center border-8 border-white rounded-lg border-double '>
